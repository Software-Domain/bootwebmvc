...
public class Todo {
	...
	public String toString() {
		...
		builder.append("Todo [id=").append(id).append(", user=").append(user).append(", desc=").append(desc)
				.append(", targetDate=").append(targetDate).append(", isDone=").append(isDone).append("]");
